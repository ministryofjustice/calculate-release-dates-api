...
class XXXTest {
  ...
  fun `Test Example`(
    ...
    CalculationTransactionalServiceTest.log.info("Testing example $exampleType/$exampleNumber")
    whenever(calculationRequestRepository.save(any())).thenReturn(CalculationTransactionalServiceTest.CALCULATION_REQUEST)
    whenever(serviceUserService.getUsername()).thenReturn(CalculationTransactionalServiceTest.USERNAME)
