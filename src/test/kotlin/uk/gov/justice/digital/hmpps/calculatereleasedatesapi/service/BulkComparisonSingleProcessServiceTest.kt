...
class BulkComparisonSingleProcessServiceTest {
  ...
  private val bulkComparisonService = BulkComparisonSingleProcessService(
  ...
  fun `Should create a prison comparison`() {
    ...
    whenever(calculationTransactionalService.validateAndCalculateForBulk(any(), any(), any(), any(), any(), isNull())).thenReturn(
      validationResult,
    )
