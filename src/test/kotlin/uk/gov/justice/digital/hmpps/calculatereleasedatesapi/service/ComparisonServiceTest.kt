...
class ComparisonServiceTest {
  ...
  fun `get a comparison person with SDS+ sentences`() {
    ...
    val latestCalculation = LatestCalculation("foo", 1L, LocalDateTime.now(), null, 1L, "BXI", "Other", "Further detail", null, CalculationSource.CRDS, emptyList(), "user1", null, "User One", null, calculationType = CalculationType.CALCULATED.name)
