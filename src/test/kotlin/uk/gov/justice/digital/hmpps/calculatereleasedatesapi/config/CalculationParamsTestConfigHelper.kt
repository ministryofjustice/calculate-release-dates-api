...
object CalculationParamsTestConfigHelper {
  ...
  fun earlyReleaseConfigurationsForTests(params: String = "calculation-params"): EarlyReleaseConfigurations =
    Binder(propertySource(params)).bind("early-release-configuration", EarlyReleaseConfigurations::class.java).get()
