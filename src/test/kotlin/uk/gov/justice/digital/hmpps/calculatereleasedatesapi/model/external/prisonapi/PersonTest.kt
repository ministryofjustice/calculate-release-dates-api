...
internal class PersonTest {
  ...
  fun `test has active sex offender alert`() {
    ...
    val person = Person("ABC1234", LocalDate.now().minusYears(23), listOf(sexOffenderAlert))
  ...
  fun `test has expired sex offender alert`() {
    ...
    val person = Person("ABC1234", LocalDate.now().minusYears(23), listOf(expiredSexOffenderAlert))
  ...
  fun `test does not have sex offender alert`() {
    ...
    val person = Person("ABC1234", LocalDate.now().minusYears(23), listOf(alert))
