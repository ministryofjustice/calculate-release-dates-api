...
@ActiveProfiles(Sds43Tests.Companion.TEST_CONFIGURATION)
class Sds43Tests : CalculationExampleTests() {

  @ParameterizedTest
  @MethodSource(value = ["testCases"])
  fun `Test calculation with sds-43 configuration`(
    example: String,
  ) {
  ...
  companion object {
    ...
    const val TEST_CONFIGURATION = "sds-43"
