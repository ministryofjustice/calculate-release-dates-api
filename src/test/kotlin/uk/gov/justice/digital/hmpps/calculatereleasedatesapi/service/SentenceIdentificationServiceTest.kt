...
class SentenceIdentificationServiceTest {
  ...
  fun `Identify before 2005 -12M`() {
    ...
    assertEquals("[ARD, SED]", sentence.releaseDateTypes.initialTypes().toString())
  }
  ...
  fun `Identify before 2005 12-48M`() {
    ...
    sentenceIdentificationService.identify(sentence, offender)
    assertEquals("[LED, CRD, SED, HDCED]", sentence.releaseDateTypes.initialTypes().toString())
  }
  ...
  fun `Identify before 2005 12-48M but is a sex offender`() {
    ...
    assertEquals("[LED, CRD, SED]", sentence.releaseDateTypes.initialTypes().toString())
  }
  ...
  fun `Identify before 2005 48M- Section 15`() {
    ...
    sentenceIdentificationService.identify(sentence, offender)
    assertEquals("[PED, NPD, LED, SED]", sentence.releaseDateTypes.initialTypes().toString())
  }
  ...
  fun `Identify before 2005 48M-`() {
    ...
    sentenceIdentificationService.identify(sentence, offender)
    assertEquals("[CRD, SLED]", sentence.releaseDateTypes.initialTypes().toString())
  }
  ...
  fun `Identify Before 2015 (After 2005 and 2012) GT 2 Years`() {
    ...
    sentenceIdentificationService.identify(sentence, offender)
    assertEquals("[SLED, CRD, HDCED]", sentence.releaseDateTypes.initialTypes().toString())
  }
  ...
  fun `Identify After 2015 LT 12 Months`() {
    ...
    sentenceIdentificationService.identify(sentence, offender)
    assertEquals("[SLED, CRD, TUSED]", sentence.releaseDateTypes.initialTypes().toString())
  }
  ...
  fun `Identify After 2015 18 Months`() {
    ...
    sentenceIdentificationService.identify(sentence, offender)
    assertEquals("[SLED, CRD, TUSED, HDCED]", sentence.releaseDateTypes.initialTypes().toString())
  }
  ...
  fun `Identify After 2015 1 day`() {
    ...
    sentenceIdentificationService.identify(sentence, offender)
    assertEquals("[SLED, CRD]", sentence.releaseDateTypes.initialTypes().toString())
  }
