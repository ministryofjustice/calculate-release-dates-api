...
class PrisonService(
  ...
  fun getActiveBookingsByEstablishment(establishmentId: String): List<SentenceSummary> {
    TODO("Not yet implemented")
    var peopleAtEstablishment = prisonApiClient.getPrisonerByEstablishment(establishmentId)
  }
}
