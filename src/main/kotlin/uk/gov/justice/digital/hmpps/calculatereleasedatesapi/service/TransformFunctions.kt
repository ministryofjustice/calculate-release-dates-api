...
fun transform(
  ...
  isValid = comparisonPerson.isValid,
  isMatch = comparisonPerson.isMatch,
  hasDiscrepancyRecord = hasDiscrepancyRecorded,
  mismatchType = comparisonPerson.mismatchType,
  isActiveSexOffender = comparisonPerson.isActiveSexOffender,
  validationMessages = transform(comparisonPerson.validationMessages, objectMapper),
  shortReference = comparisonPerson.shortReference,
  bookingId = comparisonPerson.latestBookingId,
  calculatedAt = comparisonPerson.calculatedAt,
  crdsDates = calculatedReleaseDates?.dates ?: emptyMap(),
  nomisDates = nomisDates,
