...
enum class GenuineOverrideReason(val description: String, val displayOrder: Int, val requiresFurtherDetail: Boolean) {
  ...
  CROSS_BORDER_SECTION_RELEASE_DATE("The dates need to be replaced with cross border section release dates", 3, false),
  AGGRAVATING_FACTOR_OFFENCE("One or more offences have been characterised by an aggravating factor (such as terror)", 4, false),
