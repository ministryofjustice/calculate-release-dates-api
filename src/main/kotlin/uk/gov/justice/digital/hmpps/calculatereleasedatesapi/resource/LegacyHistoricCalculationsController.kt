...
@Tag(name = "legacy-historic-calculations-controller", description = "Deprecated operations to handle historic calculations. Use /calculation-history instead")
class LegacyHistoricCalculationsController(
  ...
  @Deprecated("Use /calculation-history/{nomsId} instead")
