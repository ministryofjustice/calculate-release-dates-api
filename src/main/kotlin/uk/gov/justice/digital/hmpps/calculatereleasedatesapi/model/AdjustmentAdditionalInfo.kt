...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type", visible = true, defaultImpl = AdjustmentAdditionalInfo.NoAdjustmentAdditionalInfo::class)
@JsonSubTypes(
