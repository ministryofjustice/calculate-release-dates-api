...
class UnadjustedReleaseDate(
  ...
  findMultiplierBySentence: (sentence: AbstractSentence) -> Double,
  historicFindMultiplierBySentence: (sentence: AbstractSentence) -> Double,
   ...
   */
  var findMultiplierBySentence: (sentence: AbstractSentence) -> Double by Delegates.observable(findMultiplierBySentence) { _, _, _ ->
  ...
  private fun getSingleSentenceRelease(findMultiplierBySentence: (sentence: AbstractSentence) -> Double): ReleaseDateCalculation {
    ...
    val numberOfDaysToReleaseDateDouble =
      custodialDuration.getLengthInDays(sentence.sentencedAt).times(findMultiplierBySentence(sentence as AbstractSentence))
