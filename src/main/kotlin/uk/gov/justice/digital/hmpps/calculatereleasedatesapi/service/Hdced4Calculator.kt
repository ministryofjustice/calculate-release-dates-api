...
class Hdced4Calculator(
  ...
  fun calculateHdced4(sentence: CalculableSentence, sentenceCalculation: SentenceCalculation, extraDaysForSdsConsecToBotusDays: Int = 0) {
    val custodialPeriod = sentenceCalculation.numberOfDaysToDeterminateReleaseDateDouble

    val params = Hdced4Params(custodialPeriod, sentence.sentencedAt, getDeductedDays(sentenceCalculation), getAddedDays(sentenceCalculation, extraDaysForSdsConsecToBotusDays))
  ...
  private fun getAddedDays(sentenceCalculation: SentenceCalculation, extraDaysForSdsConsecToBotusDays: Int) = sentenceCalculation.calculatedTotalAddedDays
    .plus(sentenceCalculation.calculatedTotalAwardedDays)
    .plus(extraDaysForSdsConsecToBotusDays)
