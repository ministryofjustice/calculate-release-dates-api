...
enum class ValidationCode(
  val nomisMessage: String,
  val validationType: ValidationType = VALIDATION,
  val contentType: ValidationMessageContentType = ValidationMessageContentType.PLAIN_TEXT,
  val dpsMessage: String = "",
) {
  ...
  ADJUSTMENT_INVALID_DATE_RANGE($$"The %1$s 'from' date is after the %1$s 'to' date.<br/>Update these details in the <a href=\"%2$s/%3$s\">Adjustments service</a>.", ValidationType.VALIDATION_FIXABLE_IN_DPS, ValidationMessageContentType.HTML),
  ...
  ADJUSTMENT_LINKED_TO_INACTIVE_SENTENCE("An adjustment has been linked to an inactive sentence. You must remove any adjustments that are no longer relevant to this case. <a href=\"%s/%s\">Review the adjustments</a>.", ValidationType.VALIDATION_FIXABLE_IN_DPS, ValidationMessageContentType.HTML),
  ...
  EDS18_EDS21_EDSU18_SENTENCE_TYPE_INCORRECT("The sentence type for court case %s NOMIS line reference %s is invalid for the sentence date entered.", dpsMessage = "The sentence type for %s is invalid for the sentence date entered."),
  EDS_LICENCE_TERM_LESS_THAN_ONE_YEAR("Court case %s NOMIS line reference %s must have a licence term of at least one year.", dpsMessage = "%s must have a licence term of at least one year."),
  EDS_LICENCE_TERM_MORE_THAN_EIGHT_YEARS("Court case %s NOMIS line reference %s must have a licence term that does not exceed 8 years.", dpsMessage = "%s must have a licence term that does not exceed 8 years."),
  ...
  FTR_TYPE_14_DAYS_SENTENCE_GT_12_MONTHS("<h4>Incorrect recall term</h4><p>A 14-day fixed term recall has been selected.</p><p>Based on the sentence information, this should be a 28-day fixed term recall.</p><p>Change the fixed term recall to 28 days.</p><br/>", VALIDATION, ValidationMessageContentType.HTML),
  FTR_TYPE_14_DAYS_SENTENCE_GAP_GT_14_DAYS("<h4>Incorrect recall term</h4><p>A 14-day fixed term recall has been selected.</p><p>Based on the sentence information, this should be a 28-day fixed term recall.</p><p>Change the fixed term recall to 28 days.</p><br/>", VALIDATION, ValidationMessageContentType.HTML),
  FTR_TYPE_28_DAYS_SENTENCE_GAP_LT_14_DAYS("<h4>Incorrect recall term</h4><p>A 28-day fixed term recall has been selected.</p><p>Based on the sentence information, this should be a 14-day fixed term recall.</p><p>Change the fixed term recall to 14 days.</p><br/>", VALIDATION, ValidationMessageContentType.HTML),
  ...
  LASPO_AR_SENTENCE_TYPE_INCORRECT("The sentence type for court case %s NOMIS line reference %s is invalid for the sentence date entered.", dpsMessage = "The sentence type for %s is invalid for the sentence date entered."),
  MORE_THAN_ONE_IMPRISONMENT_TERM("Court case %s NOMIS line reference %s must only have one imprisonment term.", dpsMessage = "%s must only have one imprisonment term."),
  MORE_THAN_ONE_LICENCE_TERM("Court case %s NOMIS line reference %s must only have one licence term.", dpsMessage = "%s must only have one licence term."),
  ...
  OFFENCE_DATE_AFTER_SENTENCE_RANGE_DATE("The offence date range for court case %s NOMIS line reference %s must be before the sentence date.", dpsMessage = "The offence date range for %s must be before the sentence date."),
  OFFENCE_DATE_AFTER_SENTENCE_START_DATE("The offence date for court case %s NOMIS line reference %s must be before the sentence date.", dpsMessage = "The offence date for %s must be before the sentence date."),
  OFFENCE_MISSING_DATE("Court case %s NOMIS line reference %s must include an offence date.", dpsMessage = "%s must include an offence date."),
  ...
  SEC236A_SENTENCE_TYPE_INCORRECT("The sentence type for court case %s NOMIS line reference %s is invalid for the sentence date entered.", dpsMessage = "The sentence type for %s is invalid for the sentence date entered."),
  SEC_91_SENTENCE_TYPE_INCORRECT("The sentence type for court case %s NOMIS line reference %s is invalid for the sentence date entered.", dpsMessage = "The sentence type for %s is invalid for the sentence date entered."),
  SENTENCE_HAS_MULTIPLE_TERMS("Court case %s NOMIS line reference %s must only have one term in NOMIS.", dpsMessage = "%s must only have one term in NOMIS."),
  SENTENCE_HAS_NO_IMPRISONMENT_TERM("Court case %s NOMIS line reference %s must include an imprisonment term.", dpsMessage = "%s must include an imprisonment term."),
  SENTENCE_HAS_NO_LICENCE_TERM("Court case %s NOMIS line reference %s must include a licence term.", dpsMessage = "%s must include a licence term."),
  SOPC18_SOPC21_SENTENCE_TYPE_INCORRECT("The sentence type for court case %s NOMIS line reference %s is invalid for the sentence date entered.", dpsMessage = "The sentence type for %s is invalid for the sentence date entered."),
  SOPC_LICENCE_TERM_NOT_12_MONTHS("Court case %s NOMIS line reference %s must include a licence term of 12 months or 1 year.", dpsMessage = "%s must include a licence term of 12 months or 1 year."),
  ...
  ZERO_IMPRISONMENT_TERM("Court case %s NOMIS line reference %s must include an imprisonment term greater than zero.", dpsMessage = "%s must include an imprisonment term greater than zero."),
  ...
  REMAND_ON_OR_AFTER_SENTENCE_DATE("The 'From' or 'To' date of the remand period must be earlier than the sentence date for court case %s NOMIS line reference %s.", dpsMessage = "The 'From' or 'To' date of the remand period must be earlier than the sentence date for %s."),
