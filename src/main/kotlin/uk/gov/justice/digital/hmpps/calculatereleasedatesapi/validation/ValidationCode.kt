...
enum class ValidationCode(val message: String, val validationType: ValidationType = VALIDATION, val contentType: ValidationMessageContentType = ValidationMessageContentType.PLAIN_TEXT) {
  ...
  ADJUSTMENT_INVALID_DATE_RANGE("The remand 'from' date is after the remand 'to' date.<br/>Update these details in the <a href=\"%s/%s\">Adjustments service</a>.", ValidationType.VALIDATION_FIXABLE_IN_DPS, ValidationMessageContentType.HTML),
