...
enum class ValidationCode(val message: String, val validationType: ValidationType = VALIDATION) {
  ...
  FTR_TYPE_14_DAYS_SENTENCE_GT_12_MONTHS("<h4>Incorrect recall term</h4><p>A 14-day fixed term recall has been selected, but this person’s latest SLED comes from a sentence or aggregate that is 12 months or more.</p><p>Change the fixed term recall to 28 days.</p><br/>"),
  FTR_TYPE_14_DAYS_SENTENCE_GAP_GT_14_DAYS("<h4>Incorrect recall term</h4><p>A 14-day fixed term recall has been selected, but there are 14 days or more to the SLED, from a sentence or aggregate of 12 months or more.</p><p>Change the fixed term recall to 28 days.</p><br/>"),
  FTR_TYPE_28_DAYS_SENTENCE_GAP_LT_14_DAYS("<h4>Incorrect recall term</h4><p>A 28-day fixed term recall has been selected, but there are fewer than 14 days to the SLED, from a sentence or aggregate of 12 months or more.</p><p>Change the fixed term recall to 14 days.</p><br/>"),
