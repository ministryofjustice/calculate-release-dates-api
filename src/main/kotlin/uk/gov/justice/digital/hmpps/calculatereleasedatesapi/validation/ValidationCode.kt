...
enum class ValidationCode(val message: String, val validationType: ValidationType = VALIDATION) {
  ...
  FTR_TYPE_14_DAYS_SENTENCE_GT_12_MONTHS("Incorrect recall term. A 28-day fixed term recall has been selected, but there are fewer than 14 days to the SLED, from a sentence or aggregate of 12 months or more. Change the fixed term recall to 14 days, then reload this page"),
  FTR_TYPE_14_DAYS_SENTENCE_GAP_GT_14_DAYS("Incorrect recall term A 14-day fixed term recall has been selected, but there are 14 days or more to the SLED, from a sentence or aggregate of 12 months or more. Change the fixed term recall to 28 days, then reload this page"),
  FTR_TYPE_28_DAYS_SENTENCE_GAP_LT_14_DAYS("Incorrect recall term A 28-day fixed term recall has been selected, but there are fewer than 14 days to the SLED, from a sentence or aggregate of 12 months or more. Change the fixed term recall to 14 days, then reload this page."),
