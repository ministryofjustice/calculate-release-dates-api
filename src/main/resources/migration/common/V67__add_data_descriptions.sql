...
COMMENT ON COLUMN Approved_Dates_Submission_Approved_Dates.approved_dates_submission_id IS E'Description: The id of the approves dates submission record. \nSource System: CRDS ';
...
COMMENT ON COLUMN Calculation_Request.sentence_and_offences IS E'Description: All relevent sentence and offence data which is used as inputs in the release date calculation. \nSource System: NOMIS ';
...
COMMENT ON COLUMN Calculation_Request.calculation_type IS E'Description: The type of the calulcation.  \nSource System: CRDS ';
...
COMMENT ON COLUMN Comparison_Person.override_dates IS E'Description: This captures any release dates which have been overriden. \nSource System: NOMIS ';
...
COMMENT ON COLUMN Comparison_Person.fatal_exception IS E'Description: The error message wehn the comaprison fails to run. \nSource System: CRDS ';
COMMENT ON COLUMN Comparison_Person.latest_booking_id IS E'Description: The mose recent booking id related to the prisoner in the comparison. \nSource System: CRDS ';
...
COMMENT ON COLUMN Comparison_Person.reference IS E'Description: The reference code for the comaprison person record. \nSource System: CRDS ';
...
COMMENT ON COLUMN Comparison_Person_Discrepancy_Impact.id IS E'Description: The id of the discrepacy impact record. \nSource System: CRDS ';
...
COMMENT ON COLUMN Comparison_Person_Discrepancy_Priority.id IS E'Description: The id of the discrepancy prioriy record. \nSource System: CRDS ';
...
COMMENT ON COLUMN Genuine_Override.id IS E'Description: The id of the geunuine override record. \nSource System: CRDS ';
...
COMMENT ON COLUMN Tranche_Outcome.tranche IS E'Description: The allocated tranche from Policys understanding at the time the calculation was performed. \nSource System: CRDS ';